...
public class TapiocaGameLauncher extends AppCompatActivity {
    // the user object of the one playing the game
    User usr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        highScoretxt.setText(
                getString(R.string.highScore) + uR.getUserHighScore(username, "TAPIOCA_GAME"));
    }
  ...
  public void exitToMenu(View view) {
    ...
    public void displayInstructions(View view) {
        ...
        AlertDialog dialog = builder.setMessage(R.string.instructions_tapioca)
