...
class BoardManager {
    ...
    private List<Ball> generateTriangle() {
        ...
        for (int j = 0; j < 7; j++) {
            for (int i = 6; i > j; i--) {
                if ( (j==3 && i == 6  )|| (j == 3 && i == 4)){
                    balls.add(this.tapiocaFactory.makeWhite(50 * (2 * j + 1) + (170 * (6 - i)), 50 + (140 * j), 41));
                }
                else if(j==3 && i == 5) {
                    balls.add(this.tapiocaFactory.makePurple(50 * (2 * j + 1) + (170 * (6 - i)), 50 + (140 * j), 41));
                }
                else {
                    balls.add(this.tapiocaFactory.makeRed(50 * (2 * j + 1) + (170 * (6 - i)), 50 + (140 * j), 41));
                }
            }
        }
        return balls;
